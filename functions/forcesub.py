...
from info import AUTH_CHANNEL, FORCE_TXT
...
from database.add import add_user_to_database, add_chat_to_database
...
async def handle_force_subscribe(c: Client, m: Message):
    ...
    if m.chat.type in [ChatType.GROUP, ChatType.SUPERGROUP]:
        ...
        #await m.reply(Translation.START_TXT.format(
            #m.from_user.mention if m.from_user else m.chat.title, temp.U_NAME, temp.B_NAME),
